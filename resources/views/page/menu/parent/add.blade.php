                ...
                <div class="center">
                    <div class="row">
                        <div class="form-group-material col-sm-12">
                            ...
                            <input type="text" name="menu_parent_name" class="input-material col-sm-8" required placeholder="eg: Manage Product">
                        </div>
                    </div>
...
@section('js')
<!-- page -->
<script src="{{url('js/page/general/menu/parent.js')}}" charset="utf-8"></script>
...
<script type="text/javascript">
    this.selectIcon()
    // $('#result-icon').blobSelect.buildData();
</script>
@endsection
