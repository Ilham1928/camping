                ...
                <div class="center">
                    <div class="row">
                        <div class="form-group-material col-sm-12">
                            ...
                            <input type="text" name="role_name" value="{{ $data['role_name'] }}" class="input-material col-sm-8" required placeholder="eg: Business Development">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group-material col-sm-12">
                            <label class="col-sm-2 form-control-label">Role Description :</label>
                            <textarea name="role_description" id="desc" rows="3" class="input-material col-sm-8" placeholder="eg: Manage All Content" required>{{ $data['role_description'] }}</textarea>
                        </div>
                    </div>
                </form>
            </div>
